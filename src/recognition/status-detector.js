 ...
 * 通过图像识别检测委托的完成/未完成状态
 */
import { PATHS, COMMISSION_CONFIG, COMMISSION_DETAIL_BUTTONS, THRESHOLDS, COMMISSION_STATUS_REGIONS } from "../config/index.js";
 ...
 * @returns {Promise<string>} "completed" | "uncompleted" | "unknown"
 */
export async function detectCommissionStatusByName(commissionName) {
  try {
