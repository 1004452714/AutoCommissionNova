...
const emit = defineEmits<{ changed: [step: ProcessStep]; changeType: [type: string]; recordPath: [field?: string]; editSubprocess: [path: string] }>();
